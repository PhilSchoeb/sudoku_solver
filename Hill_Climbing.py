...
# le numéro 4 : Hill climbing sans la propagation des contraintes
    ...
    for car in carres:
        ...
        for s in car:
            if len(values[s][0]) == 1:
                ...
                values[s] = (values[s][0], False)  # Boolean becomes False so we can't modify this value
...
# Problem class used for resolution
