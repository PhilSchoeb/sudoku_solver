...
# le numéro 4 : Hill searching sans la propagation des contraintes
...
# On a modifié la fonction hill climbing pour qu'elle fonctionne comme voulu
...
def solve_all(grids, name='', showif=0.0):
    ...
    def solve_single(grid):
        ...
        if solved(values):
            print("Solved without Hill searching")
            t = time.time() - start
            return t, True, 1, 0
        ...
        print("Using Hill Searching, went from %d to %d" % (initial_score, final_score))
    ...
    N = len(grids)
    if N >= 1:
        print("Hill Searching")
        print("Solved %d of %d %s puzzles, and %d were solved without Hill_Searching, (avg %.8f secs (%d Hz), "
