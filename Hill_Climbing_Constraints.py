...
# le numéro 4 : Hill climbing avec la propagation des contraintes
    ...
    for car in carres:
        ...
        for s in car:
            if len(values[s][0]) == 1:
                ...
                values[s] = (values[s][0], False)  # Something important, here the values found with the constraints'
                # propagation are not editable since we know for sure they are at the right place
...
def solve_all(grids, name='', showif=0.0):
    ...
    def solve_single(grid):
        ...
        if solved(values):
            print("Solved without Hill Climbing")
            t = time.time() - start
            return t, True, 1
